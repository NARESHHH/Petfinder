...
enum Condition { Adoption, Mating, Disappear }
...
class Pet {
  ...
  Pet(this.name, this.location, this.distance, this.condition, this.catagory,
      this.imgurl, this.favorites, this.newest);
}
...
List<Pet> getPetList() {
  return <Pet>[
    ...
    Pet("Checkered Giant Rabbit", "New York", "2.5", "Adoption", Category.BUNNY,
        "assets/images/bunnies/bunny_5.jpg", true, false),
